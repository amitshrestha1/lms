        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#ui-department" aria-expanded="false" aria-controls="ui-basic">
                            <iconify-icon icon="pepicons-pop:letter" width="32" height="32"></iconify-icon>
                          <span class="menu-title">Leave Application</span>
                          <i class="menu-arrow"></i> 
                        </a>
                        <div class="collapse" id="ui-department">
                          <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{route('leave.create')}}">Apply for Leave</a></li>
                            <li class="nav-item"> <a class="nav-link" href="{{route('leave.list')}}">View Applications</a></li>
                          </ul>
                        </div>
                      </li>
                    <li class="nav-item">
